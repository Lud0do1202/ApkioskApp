	...
	return (
		<Box
			...
			<Box display={'flex'} flexDirection={'column'} width={'40%'} gap={3}>
				<LegendPieChart color={theme.palette.error.main} label="Bloqué" value={nbTasksBlocked} total={nbTasksTot} />
				<LegendPieChart color={theme.palette.info.main} label="En cours" value={nbTasksInProgress} total={nbTasksTot} />
				<LegendPieChart
